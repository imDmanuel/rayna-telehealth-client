  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input text-neutral-700 bg-background shadow-sm hover:bg-accent hover:text-accent-foreground",
        secondary:
      ...
      size: {
        ...
        sm: "h-[2.25rem] rounded-lg px-4 text-sm font-semibold",
        lg: "h-[3.5rem] rounded-lg px-4 text-base font-semibold",
        "icon-sm": "size-[2.25rem]",
        "icon-lg": "size-[3.5rem]",
      },
    },
    defaultVariants: {
